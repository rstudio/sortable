...
The [`esquisse` package](https://github.com/dreamRs/esquisse) lets 'you explore your data quickly to extract the information they hold. You can only create simple plots, you won’t be able to use custom scales and all the power of ggplot2. This is just the start!'

There is also the [`shinyjqui` package](https://yang-tang.github.io/shinyjqui/), an 'R wrapper for jQuery UI javascript library. It allows user to easily add interactions and animation effects to a shiny app
'.
