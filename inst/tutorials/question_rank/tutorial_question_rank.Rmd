...
## Changing the 'sortable.js' options

You can change the behaviour of the HTML widget by sending different options to the `sortable.js` library.  For example, to change the duration of animation, set `sortable_options(animation = ...)`:
