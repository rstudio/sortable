...
<img src="man/figures/sortable_list_shiny.gif" style = 'width:400px;'></img>

</center>

### Bucketable list

Witha a bucketable list you can have more than one sortable lists in a
single object. This can be useful for bucketing task, e.g. asking your
students to classify objects into multiple categories.

<center>

<img src="man/figures/bucketable_list_shiny.gif" style = 'width:500px;'></img>
